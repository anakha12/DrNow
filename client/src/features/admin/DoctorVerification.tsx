...
const DoctorVerification = () => {
  ...
  return (
    <div>
      <h1 className="text-2xl font-bold text-blue-700 mb-6">Doctor Verification</h1>
      <div className="overflow-x-auto">
        ...
        <div className="flex justify-between items-center mt-4">
          <button
            ...
            className="px-4 py-2 rounded-lg bg-blue-200 text-blue-700 font-semibold disabled:opacity-50"
          >
            Previous
          </button>
